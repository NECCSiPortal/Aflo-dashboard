...
SET_METHOD_LIST = [
    ...
    'change_setting',
    'project_payforuse_registration_entry_not_unauthorized_users',
    'sign_out',
    #  Project user.
    'sign_in_project_user',
    'project_payforuse_registration_entry',
    'project_payforuse_registration_canceled',
    'sign_out',
    #  Approval user.
    'sign_in_project_admin',
    'project_payforuse_registration_approval_final_approval',
    'project_payforuse_registration_approval_rejected',
    'project_payforuse_registration_approval_double_contract',
    'project_payforuse_cancelling_entry_not_unauthorized_users',
    'sign_out',
    #  Project user.(double contract error)
    'sign_in_project_user',
    'project_payforuse_registration_entry_double_contract',
    # Pay-for-use cancelling.
    #  Project user.
    'project_payforuse_cancelling_irregular_entry',
    'project_payforuse_cancelling_entry',
    'project_payforuse_cancelling_canceled',
    'sign_out',
    #  Approval user.
    'sign_in_project_admin',
    'project_payforuse_cancelling_approval_final_approval',
    'project_payforuse_cancelling_approval_rejected',
    'project_payforuse_cancelling_approval_double_cancelling',
    'sign_out',
...
class BrowserTests(test.SeleniumTestCase):
    ...
    def project_payforuse_registration_entry_not_unauthorized_users(self):
    ...
    def project_payforuse_registration_entry(self):
        ...
        self._project_registration_form_show(
            ...
            FORM_CREATE)
        self._test_payforuse_registration_irregular_max_length_over()
    ...
    def _test_payforuse_registration_irregular_max_length_over(self):
        """Entry a 'Pay-for-use Registration' ticket.
    ...
    def project_payforuse_registration_canceled(self):
    ...
    def project_payforuse_registration_approval_double_contract(self):
    ...
    def project_payforuse_cancelling_entry_not_unauthorized_users(self):
        """Not unauthorized_users Entry a 'Pay-for-use Cancelling' ticket"""
        self._project_contract_list(True)

    # ==================================================

    def project_payforuse_registration_entry_double_contract(self):
        """Create 'Pay-for-use Registration' double contract error test"""
        self._project_ticket_templates_list(True)
        self._project_registration_form_show(
            TICKET_TEMPLATE_ID_PAYFORUSE_REGISTRATION,
            FORM_CREATE)
    ...
    def project_payforuse_cancelling_irregular_entry(self):
        """Entry a 'Pay-for-use Cancelling' ticket.
        Required error pattern.
        """
        self._project_contract_list(True)
        self._click_ticket_list('contracts', 7, 1)
        self._test_payforuse_cancelling_irregular_max_length_over()
    ...
    def project_payforuse_cancelling_entry(self):
        """Entry a 'Pay-for-use Cancelling' ticket"""
        self._project_contract_list(True)
        self._click_ticket_list('contracts', 2, 1)
        self.click_css('a.btn-edit')
        self._test_payforuse_cancelling_entry(True)
        ...
        for i in range(3):
            ...
            if i == 0:
                ...
                self._test_payforuse_cancelling_entry(False)

    # ==================================================

    def _test_payforuse_cancelling_irregular_max_length_over(self):
        """Entry a 'Pay-for-use Cancelling' ticket.
        Max length error pattern.
        """
        # Test Message(over).
    ...
    def _test_payforuse_cancelling_entry(self, save_screen=True):
        """Entry a 'Pay-for-use Cancelling' ticket.
        :param save_screen: Save screenshot image.
        """
        if save_screen:
    ...
    def project_payforuse_cancelling_approval_final_approval(self):
    ...
    def project_payforuse_cancelling_canceled(self):
    ...
    def project_payforuse_cancelling_approval_rejected(self):
    ...
    def project_payforuse_cancelling_approval_double_cancelling(self):
        """Update 'Pay-for-use Cancelling' status to final approval"""
        # Show ticket list form.
        self._project_ticket_list()
        # Update status.
