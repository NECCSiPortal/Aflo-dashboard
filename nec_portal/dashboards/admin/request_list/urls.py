...
from nec_portal.dashboards.admin.request_list.wf_engine.detail \
    import urls as wf_engine_detail
from nec_portal.dashboards.admin.request_list.wf_engine.update \
    import urls as wf_engine_update

url_pattern = 'nec_portal.dashboards.admin.request_list.views'
