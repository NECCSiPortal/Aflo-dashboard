...
class RequestFilterAction(tables.FilterAction):
...
class EditTicket(tables.LinkAction):
    ...
    def get_link_url(self, ticket=None):
        url = 'horizon:admin:request_list:wf_engine_update:index'
...
def get_detail_link_url(ticket):
    url = 'horizon:admin:request_list:wf_engine_detail:index'
    return reverse(url, args=[ticket.ticket_id])
...
class RequestTable(tables.DataTable):
    ...
    class Meta(object):
        ...
        table_actions = (RequestFilterAction,)
