...
from nec_portal.dashboards.admin.ticket_list import tables
from nec_portal.dashboards.admin.ticket_list import views
...
TICKET_TYPE = 'New Contract,Cancel Contract'
...
class TicketListViewTest(aflo_test.BaseAdminViewTests):
    ...
    def test_ticket_list_index(self):
        ...
        self.mox.ReplayAll()
        res = self.client.get(reverse("horizon:admin:ticket_list:index"))

        self.assertNoFormErrors(res)
        self.assertTemplateUsed(res, 'admin/ticket_list/index.html')
...
class TicketListViewPaginationTest(aflo_test.BaseAdminViewTests):
    ...
    def test_tickets_list_get_pagination(self):
        ...
        self.mox.ReplayAll()
        index_url = reverse("horizon:admin:ticket_list:index")
...
class TicketListViewFilterTest(aflo_test.BaseAdminViewTests):
    ...
    def test_ticket_list_get_filter_project(self):
    ...
    def test_ticket_list_get_filter_category(self):
        ...
        filter_option = {
            ...
            "filter_string": "New Contract",
            "result": {"ticket_type": "New Contract"}
        }
